if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("Pratice", "form", "./Pratice/", "session", null, "", "0", "0");
        ...
        nexacro._addService("Form", "form", "./Form/", "none", null, "", "0", "0");
        ...
        nexacro._addService("SvcUrl", "JSP", "http://demo.nexacro.com/edu/edusysN/", "none", null, "", "0", "0");
        nexacro._addService("LocalUrl", "JSP", "http://localhost:8088/edusys/", "none", null, "", "0", "0");
        nexacro._addService("EduJs", "js", "./nexacrolib/component/", "session", null, "", "0", "0");
        nexacro._addService("svc", "JSP", "http://localhost:9090/", "none", null, "", "0", "0");
    ...
    {
        // Variables
        nexacro.setEnvironmentVariable("ev_runMode", "0");
        nexacro.setEnvironmentVariable("ev_messagePopup", "true");
        nexacro.setEnvironmentVariable("ev_userID", "");
        nexacro.setEnvironmentVariable("ev_userName", "");
        nexacro.setEnvironmentVariable("evLanguageChange", "KR");
        nexacro.setEnvironmentVariable("ev_authorty", "");
        // Cookies
