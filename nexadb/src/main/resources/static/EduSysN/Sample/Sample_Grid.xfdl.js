(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_keystring("");
            obj._setContents("<ColumnInfo><Column id=\"EMPL_ID\" type=\"STRING\" size=\"10\"/><Column id=\"FULL_NAME\" type=\"STRING\" size=\"50\"/><Column id=\"DEPT_CD\" type=\"STRING\" size=\"10\"/><Column id=\"POS_CD\" type=\"STRING\" size=\"10\"/><Column id=\"HIRE_DATE\" type=\"DATE\" size=\"10\"/><Column id=\"SALARY\" type=\"INT\" size=\"10\"/><Column id=\"GENDER\" type=\"STRING\" size=\"10\"/><Column id=\"MARRIED\" type=\"STRING\" size=\"10\"/><Column id=\"MEMO\" type=\"STRING\" size=\"10\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"EMPL_ID\">AA001</Col><Col id=\"FULL_NAME\">Olivia</Col><Col id=\"DEPT_CD\">01</Col><Col id=\"POS_CD\">03</Col><Col id=\"HIRE_DATE\">20101003</Col><Col id=\"SALARY\">83000</Col><Col id=\"GENDER\">W</Col><Col id=\"MARRIED\">true</Col><Col id=\"MEMO\">ivory</Col><Col id=\"CHK\">0</Col></Row><Row><Col id=\"EMPL_ID\">AA002</Col><Col id=\"FULL_NAME\">John</Col><Col id=\"DEPT_CD\">02</Col><Col id=\"POS_CD\">04</Col><Col id=\"HIRE_DATE\">20051011</Col><Col id=\"SALARY\">76000</Col><Col id=\"GENDER\">M</Col><Col id=\"MARRIED\">false</Col><Col id=\"MEMO\">greenyellow</Col><Col id=\"CHK\">0</Col></Row><Row><Col id=\"EMPL_ID\">BB001</Col><Col id=\"FULL_NAME\">Jackson</Col><Col id=\"DEPT_CD\">03</Col><Col id=\"POS_CD\">03</Col><Col id=\"HIRE_DATE\">20070206</Col><Col id=\"SALARY\">95000</Col><Col id=\"GENDER\">M</Col><Col id=\"MARRIED\">true</Col><Col id=\"MEMO\">aliceblue</Col><Col id=\"CHK\">0</Col></Row><Row><Col id=\"EMPL_ID\">BB002</Col><Col id=\"FULL_NAME\">Maia</Col><Col id=\"DEPT_CD\">04</Col><Col id=\"POS_CD\">02</Col><Col id=\"HIRE_DATE\">20090512</Col><Col id=\"SALARY\">60000</Col><Col id=\"GENDER\">W</Col><Col id=\"MARRIED\">false</Col><Col id=\"MEMO\">ivory</Col><Col id=\"CHK\">0</Col></Row><Row><Col id=\"EMPL_ID\">CC001</Col><Col id=\"FULL_NAME\">Adam</Col><Col id=\"DEPT_CD\">01</Col><Col id=\"POS_CD\">04</Col><Col id=\"HIRE_DATE\">20010109</Col><Col id=\"SALARY\">88000</Col><Col id=\"GENDER\">M</Col><Col id=\"MARRIED\">true</Col><Col id=\"MEMO\">greenyellow</Col><Col id=\"CHK\">0</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Static("sta_00","10","10","157","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Grid");
            ...
            obj = new Static("Static05","10","46","157","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("체크박스");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","77","320","200",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_binddataset("ds_chk");
            obj.set_autofittype("col");
            obj.getSetter("griduserproperty").set("checkbox,!sort,!rowfix,!colfix,!filter,!initial");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Empl ID\"/><Cell col=\"1\" text=\"Name\"/></Band><Band id=\"body\"><Cell text=\"bind:EMPL_ID\"/><Cell col=\"1\" text=\"bind:FULL_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static06","340","46","157","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("순번");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","340","77","320","200",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Static("Static07","670","46","157","26",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Row 상태");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid02","670","77",null,"200","10",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_binddataset("ds_status");
            obj.set_autofittype("col");
            obj.getSetter("griduserproperty").set("status,!sort,!rowfix,!colfix,!filter,!initial");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Empl ID\"/><Cell col=\"1\" text=\"Name\"/></Band><Band id=\"body\"><Cell text=\"bind:EMPL_ID\" edittype=\"normal\"/><Cell col=\"1\" text=\"bind:FULL_NAME\" edittype=\"normal\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_add",null,"50","26","22","42",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_cssclass("btn_WF_Add");
            this.addChild(obj.name, obj);

            obj = new Button("btn_del",null,"50","26","22","10",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WF_Del");
            this.addChild(obj.name, obj);

            obj = new Static("Static09","10","287","97","26",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("기본기능");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid03","10","318","492","211",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_binddataset("ds_emp");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"Empl ID\"/><Cell col=\"2\" text=\"Name\"/><Cell col=\"3\" text=\"Dept\"/><Cell col=\"4\" text=\"Position\"/><Cell col=\"5\" text=\"Hire Date\"/><Cell col=\"6\" text=\"Salary\"/><Cell col=\"7\" text=\"Gender\"/><Cell col=\"8\" text=\"Married\"/><Cell col=\"9\" text=\"Memo\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:EMPL_ID\"/><Cell col=\"2\" text=\"bind:FULL_NAME\"/><Cell col=\"3\" text=\"bind:DEPT_CD\"/><Cell col=\"4\" text=\"bind:POS_CD\"/><Cell col=\"5\" text=\"bind:HIRE_DATE\"/><Cell col=\"6\" text=\"bind:SALARY\"/><Cell col=\"7\" text=\"bind:GENDER\"/><Cell col=\"8\" text=\"bind:MARRIED\"/><Cell col=\"9\" text=\"bind:MEMO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid04","512","318",null,"211","10",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_binddataset("ds_emp");
            ...
            obj = new Static("Static10","512","287","97","26",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("모든기능");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","10","539","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("복잡한 그리드");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid05","10","570",null,"425","10",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_binddataset("ds_emp");
            obj.getSetter("griduserproperty").set("replace,colhide,userheader");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"112\"/><Column size=\"117\"/><Column size=\"91\"/><Column size=\"92\"/><Column size=\"114\"/><Column size=\"107\"/></Columns><Rows><Row size=\"28\" band=\"head\"/><Row size=\"28\" band=\"head\"/><Row size=\"28\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell colspan=\"3\"/><Cell col=\"3\"/><Cell col=\"4\" colspan=\"2\"/><Cell row=\"1\" text=\"EMPL_ID\" calendarweekformat=\"bind:EMPL_ID\"/><Cell row=\"1\" col=\"1\" text=\"DEPT_CD\" calendarweekformat=\"bind:DEPT_CD\"/><Cell row=\"1\" col=\"2\" text=\"GENDER\" calendarweekformat=\"bind:GENDER\"/><Cell row=\"1\" col=\"3\" text=\"MARRIED\" calendarweekformat=\"bind:MARRIED\"/><Cell row=\"1\" col=\"4\" text=\"HIRE_DATE\" calendarweekformat=\"bind:HIRE_DATE\"/><Cell row=\"1\" col=\"5\" text=\"SALARY\" calendarweekformat=\"bind:SALARY\"/><Cell row=\"2\" text=\"FULL_NAME\" calendarweekformat=\"bind:FULL_NAME\"/><Cell row=\"2\" col=\"1\" text=\"POS_CD\" calendarweekformat=\"bind:POS_CD\"/><Cell row=\"2\" col=\"2\" colspan=\"2\"/><Cell row=\"2\" col=\"4\" colspan=\"2\" text=\"Memo\" calendarweekformat=\"bind:MEMO\"/></Band><Band id=\"body\"><Cell text=\"bind:EMPL_ID\"/><Cell col=\"1\" text=\"bind:DEPT_CD\"/><Cell col=\"2\" rowspan=\"2\" text=\"bind:GENDER\"/><Cell col=\"3\" rowspan=\"2\" text=\"bind:MARRIED\"/><Cell col=\"4\" text=\"bind:HIRE_DATE\"/><Cell col=\"5\" text=\"bind:SALARY\"/><Cell row=\"1\" text=\"bind:FULL_NAME\"/><Cell row=\"1\" col=\"1\" text=\"bind:POS_CD\"/><Cell row=\"1\" col=\"4\" colspan=\"2\" text=\"bind:MEMO\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","146","7","194","60",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("property 우클릭 add\r\ngriduserproperty");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
