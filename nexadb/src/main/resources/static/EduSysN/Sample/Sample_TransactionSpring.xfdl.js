(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_search","10","45",null,"51","10",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edt_name","130","9","120","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static00","0","9","130","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("성명");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static01","250","9","130","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("부서");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static02","560","9","130","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_text("직급");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Combo("cmb_dept","380","9","180","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            ...
            obj = new Combo("cmb_pos","690","9","180","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btn_reset",null,"9","66","30","10",null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("초기화");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static05","10","96","97","35",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("조회결과");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save",null,"10","54","30","224",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("저장");
            ...
            obj = new Button("btn_delete",null,"10","54","30","283",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("삭제");
            obj.set_visible("true");
            obj.set_cssclass("btn_WF_FrmMain");
            ...
            obj = new Button("btn_add",null,"10","54","30","342",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("입력");
            obj.set_visible("true");
            obj.set_cssclass("btn_WF_FrmMain");
            ...
            obj = new Button("btn_search",null,"10","54","30","401",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("조회");
            obj.set_visible("true");
            obj.set_cssclass("btn_WF_FrmMain");
            ...
            obj = new Button("btn_code","359","10","90","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("공통코드");
            obj.set_cssclass("btn_WF_FrmMain");
            this.addChild(obj.name, obj);

            obj = new Button("btn_excelExport",null,"10","102","30","117",null,null,null,null,null,this);
            obj.set_taborder("13");
            ...
            obj = new Button("btn_excelImport",null,"10","102","30","10",null,null,null,null,null,this);
            obj.set_taborder("14");
            ...
            obj = new Static("Static03_00","0","40",null,"5","0",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h5");
            ...
            obj = new Static("Static00_00_00","439","96","150","35",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h35");
