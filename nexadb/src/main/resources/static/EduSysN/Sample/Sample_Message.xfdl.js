(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_00","10","10","86","26",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Message");
            obj.set_cssclass("sta_WF_TitleMain");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_list","10","46",null,null,"264","10",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("gds_message");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"300\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"MSG_ID\"/><Cell col=\"1\" text=\"MSG_TEXT\"/><Cell col=\"2\" text=\"MSG_TYPE\"/></Band><Band id=\"body\"><Cell text=\"bind:MSG_ID\"/><Cell col=\"1\" text=\"bind:MSG_TEXT\"/><Cell col=\"2\" text=\"bind:MSG_TYPE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_word",null,"10","66","26","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Word");
            ...
            obj = new Button("btn_alert",null,"10","146","26","425",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Grid("grd_word",null,"45","244",null,"10","10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_binddataset("gds_word");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"110\"/><Column size=\"110\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"WORD_ID\"/><Cell col=\"1\" text=\"KR\"/></Band><Band id=\"body\"><Cell text=\"bind:WORD_ID\"/><Cell col=\"1\" text=\"bind:KR\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_confirm",null,"10","146","26","274",null,null,null,null,null,this);
            obj.set_taborder("5");
