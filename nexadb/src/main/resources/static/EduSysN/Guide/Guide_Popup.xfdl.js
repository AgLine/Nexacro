(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_search","20","52","540","44",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Combo("cmb_dept","80","8","120","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01","0","8","80","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("부서");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static00","200","8","80","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("성명");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Edit("edt_name","280","8","120","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static05","23","106","97","26",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("조회결과");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_list","20","132",null,"113","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("Static12","20","255","97","26",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("상세정보");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Static("Static16","18","393",null,"10","12",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h10");
            ...
            obj = new Div("Div00","20","281","540","112",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("Div00");
            obj.set_cssclass("div_WF_Detail");
            this.addChild(obj.name, obj);

            obj = new Static("Static07","0","8","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static10","0","42","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static13","0","76","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_text("성별");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static09","230","8","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static11","230","42","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_text("사원번호");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static14","230","76","80","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            obj.set_text("전화번호");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("Combo00","80","8","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            obj.set_text("Combo00");
            this.Div00.addChild(obj.name, obj);

            obj = new Edit("Edit00","80","42","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            this.Div00.addChild(obj.name, obj);

            obj = new Radio("Radio00","80","76","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_direction("vertical");
            var Div00_form_Radio00_innerdataset = new nexacro.NormalDataset("Div00_form_Radio00_innerdataset", obj);
            Div00_form_Radio00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">남자</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">여자</Col></Row></Rows>");
            obj.set_innerdataset(Div00_form_Radio00_innerdataset);
            this.Div00.addChild(obj.name, obj);

            obj = new Combo("Combo01","310","8","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_text("Combo01");
            this.Div00.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit00","310","42","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("10");
            this.Div00.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit01","310","76","150","26",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("11");
            this.Div00.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this
            obj = new Layout("default","",580,450,this,function(p){});
