(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta00","20","20","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("대상칼럼");
            obj.getSetter("uWord").set("popup.targetcolumn");
            obj.set_cssclass("sta_WF_DetailLabeltext");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo00","150","20","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Static("sta01","20","55","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("찾을 문자열");
            ...
            obj = new Static("sta02","20","90","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("바꿀 문자열");
            ...
            obj = new Static("sta03","20","145","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("찾을 방향");
            ...
            obj = new Radio("rdo00","150","145","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Static("sta04","20","180","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("찾을 위치");
            ...
            obj = new Radio("rdo01","150","180","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_direction("vertical");
            ...
            obj = new Static("sta05","20","215","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("찾을 조건");
            ...
            obj = new Radio("rdo02","150","215","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_direction("vertical");
            ...
            obj = new CheckBox("chk00","150","250","140","26",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("대/소문자구분");
            obj.getSetter("uWord").set("popup.casesensitive");
            this.addChild(obj.name, obj);

            obj = new Button("btn00","370","20","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("찾기");
            obj.getSetter("uWord").set("popup.find");
            this.addChild(obj.name, obj);

            obj = new Button("btn01","370","55","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("바꾸기");
            obj.getSetter("uWord").set("popup.replace");
            this.addChild(obj.name, obj);

            obj = new Button("btn02","370","90","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("모두바꾸기");
            obj.getSetter("uWord").set("popup.allchange");
            this.addChild(obj.name, obj);

            obj = new Button("btn03","370","125","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("닫기");
            obj.getSetter("uWord").set("popup.close");
            this.addChild(obj.name, obj);

            obj = new Edit("edt00","150","55","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Edit("edt01","150","90","180","26",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",480,300,this,function(p){});
